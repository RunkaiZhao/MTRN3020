 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Wed Apr 15 18:30:41 2020
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME LoadSim
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void LoadSim_Outputs_wrapper(const real_T *u0,
			const real_T *u1,
			real_T *y0,
			const real_T *xC);
extern void LoadSim_Derivatives_wrapper(const real_T *u0,
			const real_T *u1,
			real_T *y0,
			real_T *dx,
			real_T *xC);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    LoadSim_Outputs_wrapper(u0, u1, y0, xC);
...
static void mdlDerivatives(SimStruct *S)
{
    ...
    LoadSim_Derivatives_wrapper(u0, u1, y0, dx, xC);
